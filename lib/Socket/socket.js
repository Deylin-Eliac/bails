...
const makeSocket = (config) => {
    ...
    if (!creds.pairingEphemeralKeyPair) {
        creds.pairingEphemeralKeyPair = Utils_1.Curve.generateKeyPair();
    }
    ...
    const requestPairingCode = async (phoneNumber, pairKey) => {
        const pairingCode = pairKey ? pairKey.toUpperCase() : (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5));
